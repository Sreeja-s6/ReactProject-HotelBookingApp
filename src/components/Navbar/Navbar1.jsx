...
const Navbar1 = () => {
  ...
  const { wishlist, clearWishlist } = useContext(WishlistContext); // ✅ added clearWishlist
  ...
  // Remove wishlist for this user
  if (authUser) {
    localStorage.removeItem(`wishlist_${authUser.email}`);
  }

  // Fallback for guest (if any)
